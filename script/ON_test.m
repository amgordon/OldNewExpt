...
theData.item = list.testItems;
theData.oldNew = list.testOldNew;
theData.absCon = list.testAbsCon;
...
% Diagram of trial
stimTime = .5;  % the word and main response time
respEndTime = 2;  % for running out of time
...
%         Screen(S.Window,'Flip');
%         qKeys(ons_start,goTime2,S.kbNum);  % not collecting keys, just a delay
